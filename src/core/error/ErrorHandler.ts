...
export class ErrorHandler {
    ...
    public handleError(error: Error | string, context?: ErrorContext): ErrorDetails {
    ...
    private createErrorDetails(error: Error | string, context?: ErrorContext): ErrorDetails {
    ...
    private analyzeError(message: string, context?: ErrorContext): { severity: ErrorSeverity; category: ErrorCategory } {
        // Default values
