...
function StatisticsPanel({ history }: StatisticsPanelProps): React.ReactElement {
    const [stats, setStats] = React.useState<CommandStatistics>(history.getStatistics());
    const [productivity, setProductivity] = React.useState<ProductivityStats>(history.getProductivityStats());
        ...
        <div className="latex-translator-statistics">
            <div className="statistics-header">
                ...
                <div className="statistics-summary">
                    <span>Success Rate: {formatNumber(productivity.successRate * 100)}%</span>
                    <span>Commands/Hour: {formatNumber(productivity.commandsPerHour)}</span>
            ...
            <div className="statistics-grid">
                <div className="statistics-card">
                    ...
                    <div className="statistics-data">
                        ...
                        <div>Avg. Processing: {formatNumber(productivity.averageProcessingTime)}ms</div>
                ...
                <div className="statistics-card">
                    ...
                    <div className="statistics-data">
                        <div>Math/Command: {formatNumber(productivity.conversionEfficiency.mathPerCommand)}</div>
                        <div>Citations/Command: {formatNumber(productivity.conversionEfficiency.citationsPerCommand)}</div>
                        <div>Environments/Command: {formatNumber(productivity.conversionEfficiency.environmentsPerCommand)}</div>
                        <div>References/Command: {formatNumber(productivity.conversionEfficiency.referencesPerCommand)}</div>
                        <div>Macros/Command: {formatNumber(productivity.conversionEfficiency.macrosPerCommand)}</div>
                    </div>
                </div>
