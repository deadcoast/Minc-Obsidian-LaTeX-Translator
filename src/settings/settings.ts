      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .onChange(async (value) => {
            this.plugin.getSettings().direction = value as
              | 'latex-to-obsidian'
              | 'obsidian-to-latex';
  ...
  private addEnvironmentSettings(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().environmentConversion
              .preserveOriginalOnUnknown
          )
          .onChange(async (value) => {
            this.plugin.getSettings().environmentConversion.preserveOriginalOnUnknown =
              value;
            await this.plugin.saveSettings();
          })
      );
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'Additional environment names to treat as display math (comma-separated)'
      )
      .addText((text) =>
        text
          ...
          .setValue(
            Object.keys(
              this.plugin.getSettings().environmentConversion.customMappings
            ).join(', ')
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .setValue(
            this.plugin.getSettings().labelAndReference.referenceHandling
          )
          .onChange(async (value) => {
            this.plugin.getSettings().labelAndReference.referenceHandling =
              value as 'ignore' | 'placeholder' | 'autoNumber' | 'text';
            await this.plugin.saveSettings();
          })
      );
    ...
    new Setting(autoNumberingContainer)
      ...
      .addText((text) =>
        text
          ...
          .setValue(
            String(
              this.plugin.getSettings().labelAndReference.autoNumbering
                .startEquation
            )
          )
          .onChange(async (value) => {
            const num = parseInt(value);
            if (!isNaN(num)) {
              this.plugin.getSettings().labelAndReference.autoNumbering.startEquation =
                num;
              await this.plugin.saveSettings();
            }
          })
      ...
      .addText((text) =>
        text
          ...
          .onChange(async (value) => {
            const num = parseInt(value);
            if (!isNaN(num)) {
              this.plugin.getSettings().labelAndReference.autoNumbering.startFigure =
                num;
              await this.plugin.saveSettings();
            }
          })
      ...
      .addText((text) =>
        text
          ...
          .onChange(async (value) => {
            const num = parseInt(value);
            if (!isNaN(num)) {
              this.plugin.getSettings().labelAndReference.autoNumbering.startTable =
                num;
              await this.plugin.saveSettings();
            }
          })
      ...
      .addText((text) =>
        text
          ...
          .onChange(async (value) => {
            const num = parseInt(value);
            if (!isNaN(num)) {
              this.plugin.getSettings().labelAndReference.autoNumbering.startSection =
                num;
              await this.plugin.saveSettings();
            }
          })
  ...
  private addUISettings(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .setValue(
            this.plugin.getSettings().uiSettings.previewPanelPosition ?? 'right'
          )
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.previewPanelPosition =
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.autoUpdatePreview ?? false
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.previewTheme = value as
              | 'auto'
              | 'light'
              | 'dark';
            await this.plugin.saveSettings();
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.previewLineNumbers ?? false
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.previewSyncScroll ?? false
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.previewShowDiff ?? false
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.showErrorNotifications ?? false
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.showWarningNotifications ??
              true
          )
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.showWarningNotifications =
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.inlineErrorHighlighting ??
              false
          )
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.inlineErrorHighlighting =
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .setValue(
            this.plugin.getSettings().uiSettings.errorHighlightStyle ||
              'underline'
          )
          .onChange(async (value) => {
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .setValue(
            this.plugin.getSettings().uiSettings.errorHighlightColor || 'red'
          )
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.errorHighlightColor = value as
              | 'red'
              | 'orange'
              | 'yellow';
            await this.plugin.saveSettings();
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(
            String(
              this.plugin.getSettings().uiSettings.errorNotificationDuration
            )
          )
          .onChange(async (value) => {
            const num = parseInt(value);
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .setValue(
            this.plugin.getSettings().uiSettings.errorGrouping || 'none'
          )
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.errorGrouping = value as
              | 'none'
              | 'type'
              | 'location';
            await this.plugin.saveSettings();
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dropdown) =>
        dropdown
          ...
          .setValue(
            this.plugin.getSettings().uiSettings.errorMinSeverity || 'error'
          )
          .onChange(async (value) => {
            this.plugin.getSettings().uiSettings.errorMinSeverity = value as
              | 'info'
              | 'warning'
              | 'error';
            await this.plugin.saveSettings();
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().uiSettings.autoExpandLogEntries ?? false
          )
  ...
  private addBatchOperationSettings(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().batchOperations.notifyOnCompletion
          )
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.notifyOnCompletion =
              value;
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        'Maximum allowed error rate before aborting batch operations (e.g., 0.2 for 20%)'
      )
      .addText((text) =>
        text
          .setPlaceholder('0.2')
          .setValue(
            String(this.plugin.getSettings().batchOperations.errorThreshold)
          )
          .onChange(async (value) => {
            ...
            if (!isNaN(num) && num >= 0 && num <= 1) {
              ...
              new Notice(
                'Please enter a valid number between 0 and 1 for the error threshold.'
              );
            }
          })
      );
    ...
    new Setting(containerEl)
      ...
      .addToggle((toggle) =>
        toggle
          .setValue(
            this.plugin.getSettings().batchOperations.autoSaveErrorReports
          )
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.autoSaveErrorReports =
              value;
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(
            this.plugin.getSettings().batchOperations.errorReportLocation
          )
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.errorReportLocation =
              value;
    ...
    new Setting(containerEl)
      ...
      .addSlider((slider) =>
        slider
          .setLimits(1, 10, 1)
          .setValue(
            this.plugin.getSettings().batchOperations.maxConcurrentFiles
          )
          .setDynamicTooltip()
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.maxConcurrentFiles =
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          .setPlaceholder('100')
          .setValue(
            String(this.plugin.getSettings().batchOperations.processDelay)
          )
          .onChange(async (value) => {
            const num = parseInt(value);
            if (!isNaN(num) && num >= 0) {
              ...
              new Notice(
                'Please enter a valid non-negative number for the process delay.'
              );
            }
          })
      );
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(
            this.plugin.getSettings().batchOperations.hotkeys.openBatchModal
          )
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.hotkeys.openBatchModal =
              value;
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(
            this.plugin.getSettings().batchOperations.hotkeys
              .quickBatchCurrentFolder
          )
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.hotkeys.quickBatchCurrentFolder =
              value;
            await this.plugin.saveSettings();
          })
      );
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          ...
          .setValue(
            this.plugin.getSettings().batchOperations.hotkeys.quickBatchVault
          )
          .onChange(async (value) => {
            this.plugin.getSettings().batchOperations.hotkeys.quickBatchVault =
              value;
